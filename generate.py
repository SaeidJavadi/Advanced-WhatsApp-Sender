...
"}")
    ...
    def retranslateUi(self, Form):
        ...
        self.generate_num.setToolTip(_translate("Form", "Digite o primeiro número desejado, sem o zero"))
        self.generate_num.setPlaceholderText(_translate("Form", "9123456789"))
        self.label.setText(_translate("Form", "Primeiro número:"))
        self.generate_count.setToolTip(_translate("Form", "Digite a quantidade desejada para criar a lista de números"))
        self.generate_count.setPlaceholderText(_translate("Form", "10"))
        self.label_2.setText(_translate("Form", "Quantidade a ser criada:"))
        self.btn_g_cancel.setToolTip(_translate("Form", "Cancelar operação"))
        self.btn_g_cancel.setText(_translate("Form", "Cancelar"))
        self.btn_g_ok.setToolTip(_translate("Form", "Criar lista"))
        self.btn_g_ok.setText(_translate("Form", "Confirmar"))
