...
"}")
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "Formulário para criar lista de números"))
        self.btn_importFile.setToolTip(_translate("Form", "Selecionar arquivo para importar"))
        self.btn_importFile.setText(_translate("Form", "Selecionar arquivo"))
        self.label.setText(_translate("Form", "Carregar números de telefone de um arquivo:"))
        self.label_2.setText(_translate("Form", "Inserir números de telefone manualmente:"))
        self.btn_importManual.setToolTip(_translate("Form", "Carregar números inseridos"))
        self.btn_importManual.setText(_translate("Form", "Carregar"))
        self.manualNumber.setToolTip(
            _translate("Form", "Digite seus números de telefone e separe-os por quebras de linha (Enter)"))
        self.btn_import_cancel.setToolTip(_translate("Form", "Cancelar operação de carregamento de números"))
        self.btn_import_cancel.setText(_translate("Form", "Cancelar"))
