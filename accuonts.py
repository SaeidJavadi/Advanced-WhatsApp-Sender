...
"}")
    ...
    def retranslateUi(self, Form):
        ...
        self.btn_import_cancel.setText(_translate("Form", "Fechar"))
        self.label_2.setText(_translate("Form", "Contas salvas:"))
        self.btn_addnewtel.setPlaceholderText(_translate("Form", "Novo número de conta"))
        self.btn_importaccount.setToolTip(_translate("Form", "Selecionar arquivo para importar"))
        self.btn_importaccount.setText(_translate("Form", "Adicionar nova conta"))
